...
public class AreaSearchIndexActivity extends AgoraActivity implements
		OnItemClickListener {
	@Override
	...
	public void onPostInitialize(Bundle savedInstanceState) {
		...
		for (Area area : Area.values()) {
			arrayAdapter.add(isLandscape ? area.toString() : area
					.getShortName());
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		intent.putExtra(IntentExtra.AREA_ID, Area.values().get(position)
				.getId());
